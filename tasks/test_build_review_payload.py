...
def metadata() -> dict[str, Any]:
    return {
        ...
        "review_engines": [
            {"name": "Claude Code", "model": "claude-opus-5-5", "effort": "max"},
...
class BuildReviewPayloadTest(unittest.TestCase):
    ...
    def test_body_always_ends_with_automated_review_footer(self) -> None:
        hunter_line = "レビューは Claude Code claude-opus-5-5 と Codex gpt-6-astra により行われました。"
    ...
    def test_footer_never_renders_effort(self) -> None:
        ...
        effort_free_line = "レビューは Claude Code claude-opus-5-5 と Codex gpt-6-astra により行われました。"
        cases = (
            ("current-max", "max"),
            ("legacy-xhigh", "xhigh"),
